...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://cleezoclass.com:4000/api/Teacherusers/${editingTeacher}`, {
        ...editFormData,
        photo: photoPath,
        schoolCode,
      });
        ...
        <div className="main-content">
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 className="footprints">Teacher Management System</h1>
...
export default TeacherManagementEdit;
