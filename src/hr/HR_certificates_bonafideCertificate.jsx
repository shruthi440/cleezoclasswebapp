...
const BonafideCertificate = ({ userData }) => {
...
>
  ...
  >
    ...
    <div className="certificate-header" style={{ marginBottom: "40px" }}>
      <p className="certificate-title">BONAFIDE CERTIFICATE</p>
    </div>
    ...
    <div className="certificate-body">
      ...
      <p style={{ marginBottom: "15px" }}>
      He/She has studied in  {localStorage.getItem("schoolCode") || "School Code will appear here"} SCHOOL and is presently
       studying in Class <strong>{formatClassName(userData.class_name)}</strong> in the academic year {getCurrentYear()}. <strong>
     
         
        </strong>
      </p>
      <p>
      His/Her date of birth as per our records is {userData.birthDate || "__________"} .
      </p>
      <p>
    This certificate is issued on his/her request for the purpose of [Scholarship / Higher Studies / Passport / Address Proof / Other Purpose].
</p></div>
