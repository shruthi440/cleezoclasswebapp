...
const ObjectionCertificate = ({ teacherId }) => {
    ...
    >
      ...
      <div>
        ...
        <div className="certificate-header" style={{marginBottom:'30px'}}>
            <p className="certificate-title"> NO OBJECTION CERTIFICATE</p>
        </div>
        ...
        <div className="certificate-body">
          ...
          <p style={{marginBottom:'15px'}}>
            It is further certified that the school has no objection to his seeking admission in any other recognized educational institution. All dues have been settled, and there are no pending obligations from the student or his parents towards the school.
          </p>
          
            <p>
                This certificate is issued upon the request of the parent for the purpose of school admission/transfer.
            </p>
                    <p>
            We extend our best wishes to the student for continued success in all future academic and personal pursuits.
          </p>
          <p>
...
export default ObjectionCertificate;
