...
const MarketingPage = () => {
  ...
  const marketingItems = [
    { color: "#D4C7B0", title: "Academics", desc: "Syllabus, Performance, Attendance, Behaviour, Certificates", link: "/marketing/academics" },
    { color: "#868C8F", title: "Meetings & Live Chat", desc: "Group Chat, Chatting assign, Parents Meetings", link: "/marketing/meetings" },
    { color: "#705B56", title: "Time-Table", desc: "Generation, Substitutes", link: "/marketing/timetable" },
    { color: "#D9EEF8", title: "Exam Management", desc: "Question Paper, Invigilator, Evaluator", link: "/marketing/exam" },
  ];
  ...
  return (
    <div style={container}>
      ...
      >
        <div style={card}>
          <div style={sectionTitle}>Marketing Dashboard</div>
          {marketingItems.map((i) => (
