...
const normalizeIdCardTemplateName = (value) => {
  const template = String(value || "").trim().toLowerCase();
  if (template === "schoolidcard.html") return "school_id_card.html";
  return /^(?:idcard(?:[1-9]|1[0-6])|school_id_card)\.html$/.test(template) ? template : DEFAULT_ID_CARD_TEMPLATE;
};

const idCardFormats = [
  { id: "idcard1.html", label: "Student ID Card 1" },
  { id: "idcard2.html", label: "Student ID Card 2" },
  { id: "idcard3.html", label: "Student ID Card 3" },
  { id: "idcard4.html", label: "Student ID Card 4" },
  { id: "idcard5.html", label: "Student ID Card 5" },
  { id: "idcard6.html", label: "Student ID Card 6" },
  { id: "idcard7.html", label: "Student ID Card 7" },
  { id: "idcard8.html", label: "Student ID Card 8" },
  { id: "idcard9.html", label: "Student ID Card 9" },
  { id: "idcard10.html", label: "Student ID Card 10" },
  { id: "idcard11.html", label: "Student ID Card 11" },
  { id: "idcard12.html", label: "Student ID Card 12" },
  { id: "idcard13.html", label: "Student ID Card 13" },
  { id: "idcard14.html", label: "Student ID Card 14" },
  { id: "idcard15.html", label: "Student ID Card 15" },
  { id: "idcard16.html", label: "Student ID Card 16" },
  { id: "school_id_card.html", label: "School ID Card" },
];
...
const normalizePerformanceForTemplate = (rows) => {
  ...
  return rows.map((row) => {
    ...
    const read = (key) => {
      ...
      return matchingKey ? fromTestEntry(tests[matchingKey]) : 0;
    };
                ...
                return (
                  ...
                  >
                    <iframe
                      ...
                      src={import.meta.env.BASE_URL + `reports/${template.id}`}
              ...
              ? idCardFormats.map((template) => {
                  ...
                  return (
                    ...
                    >
                      <iframe
                        title={`${template.label} preview`}
                        src={import.meta.env.BASE_URL + `idcards/${template.id}`}
                        className="admin-events-id-card-template-preview"
                      />
                    </button>
                  );
                })
                    ...
                    <div className="admin-events-template-row compact">
                      ...
                      >
                        {getPosterTemplates().map((template) => (
                          ...
                          >
                            {template.kind === "iframe" ? (
                              <iframe
                                title={`${template.label || template.key} preview`}
                                src={template.src}
                                className="admin-events-poster-template-preview"
                              />
                            ) : (
                              <span className="admin-events-template-art" />
                            )}
            ...
            <div className="admin-events-card-header">
              ...
              <div className="admin-events-chat-meta">
                <button
                  ...
                  onClick={handlePrintSelectedClassIdCards}
