                ...
                >
                  ...
                  >
                    ...
                    {!hasStudentAlertTime ? (
                      <button
                        type="button"
                        className="admin-academics-alert-add-btn"
                        onClick={() => navigate("/TeacherAttendanceForms?view=student")}
                      >
                        Add
                      </button>
                    ) : (
                      <button
                        type="button"
                        className="admin-academics-alert-add-btn"
                        onClick={handleResetStudentAlertTime}
                      >
                        Reset
                      </button>
                    )}
                  ...
                  >
                    ...
                    {!hasTeacherAttendanceTimes ? (
                      <button
                        type="button"
                        className="admin-academics-alert-add-btn"
                        onClick={() => navigate("/TeacherAttendanceForms?view=teacher")}
                      >
                        Add
                      </button>
                    ) : (
                      <button
                        type="button"
                        className="admin-academics-alert-add-btn"
                        onClick={handleResetTeacherAttendanceTime}
                      >
                        Reset
                      </button>
                    )}
