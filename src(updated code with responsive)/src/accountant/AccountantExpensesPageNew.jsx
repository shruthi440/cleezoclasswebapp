              ...
              <div className="accountant-fees-summary-card accountant-card">
                <div className="accountant-fees-summary-left">
                  ...
                  <div className="accountant-fees-summary-stats">
                    <p><span>Total Expenses:</span><strong>{formatINR(totalExpenseAmount)}</strong></p>
                    <p><span>Total Salaries:</span><strong>{formatINR(totalSalaryAmount)}</strong></p>
                    <p><span>Total Store Expenses:</span><strong>{formatINR(stationaryTotal)}</strong></p>
                    <p><span>Total Utilities:</span><strong>{formatINR(utilitiesTotal)}</strong></p>
                  </div>
                </div>
