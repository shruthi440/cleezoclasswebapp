...
const NoDueCertificate = ({ userData }) => {
...
const handleDownload = () => {
  ...
  html2canvas(content, {
    ...
    pdf.save('No_Due_Certificate.pdf');
  });
};
...
>
  ...
  >
    ...
    <div className="certificate-header" style={{ marginBottom: "40px" }}>
      <p className="certificate-title">NO DUE CERTIFICATE</p>
    </div>
    ...
    <div className="certificate-body">
      ...
      <p style={{ marginBottom: "15px" }}>
        {/* He/She is being{" "} */}
          has no dues pending with the school as on {getCurrentDate()}.
      
      </p>
      <p>
      The student has returned all library books, cleared all tuition/hostel/transport fees, and submitted all necessary documents.
      </p>
      <p>
   Hence, this certificate is issued to him/her for future reference.
      </p>
    </div>
...
{/* here is footer section for certification */}
<footer
  style={{
