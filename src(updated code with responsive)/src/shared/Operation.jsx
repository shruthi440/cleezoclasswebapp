...
const OperationsPage = () => {
  ...
  const operationsItems = [
    { color: "#D4C7B0", title: "Academics", desc: "Syllabus, performance, Attendance, Behaviour, Certificates", link: "/operations/academics" },
    { color: "#868C8F", title: "Meetings & Live Chat", desc: "Group Chat, Chatting assign, Parents Messaging", link: "/operations/meetings" },
    { color: "#705B56", title: "Time-Table", desc: "Generation, Substitutes", link: "/operations/timetable" },
    { color: "#D9EEF8", title: "Exam Management", desc: "Question Paper, Evaluator, Invigilator", link: "/operations/exam" },
  ];
