...
const Biometric = () => {
  ...
  useEffect(() => {
    localStorage.setItem("hrBiometricRecentActions", JSON.stringify(recentHrActions));
  }, [recentHrActions]);
    ...
    const fetchUserName = async () => {
      ...
      try {
        ...
        if (!contentType.includes("application/json")) {
          // Backend sometimes returns HTML error pages; ignore silently.
          return;
        }
  ...
  const refreshHrActionsData = async (withLog = false) => {
    ...
    if (withLog) {
      logHrAction("Actions refreshed", "Deleted users, leave requests, and edit logs reloaded");
    }
  };
...
// Optional: if you want a little box shadow for the card
const cardWithShadow = {
  ...card,
  boxShadow: "2px 2px 10px rgba(0, 0, 0, 0.1)",  // Add subtle shadow
};
...
const actionChip = {
  ...
  return (
    <div style={container}>
      ...
      >
        HR – ENROLLMENTS & BIOMETRICS STUDENT
      </div>
...
<div className="global-sectionCircle" style={{ backgroundColor: sectionColors[0] }}></div>
      <div  className="global-sectionTitle">Enrollments</div>
    </div>
    {renderActionItems(enrollmentActions, "CRM/enrollments", enrollmentColors)}
  </div>
...
<div className="global-sectionCircle" style={{ backgroundColor: sectionColors[1] }}></div>
  ...
  <div  className="global-card">
    <div className="global-sectionTitleContainer">
<div className="global-sectionCircle" style={{ backgroundColor: sectionColors[1] }}></div>
      <div  className="global-sectionTitle">Attendance</div>
    </div>
    {renderActionItems(attendanceActions, "CRM/attendance", attendanceColors)}
  </div>

  <div  className="global-card">
    <div className="global-sectionTitleContainer">
<div className="global-sectionCircle" style={{ backgroundColor: sectionColors[2] }}></div>
      <div  className="global-sectionTitle">Complaints</div>
    </div>
    <div style={{ display: "flex", flexDirection: "row", alignItems: "left", gap: "10px", marginTop: "2%", width: "100px" }}>
       <div style={{ display: "flex", flexDirection: "column", alignItems: "left", gap: "10px", marginTop: "2%", width: "100px" }}>
      ...
      <button className="btn-outline "
        style={{ height: "40px" , marginTop: "25%" }}  >OK</button>
    </div>
  </div>
</div>
        {/* Right Container */}
...
<div className="global-sectionCircle" style={{ backgroundColor: sectionColors[4] }}></div>
          ...
          <div style={actionSummaryGrid}>
            ...
            <div style={actionSummaryCard}>
              <div style={actionSummaryLabel}>Leave Requests</div>
...
<FontAwesomeIcon icon={faArrowRight} style={styles.arrow} />
  ...
  <div
    style={popupOverlay}
    onClick={() => setPopup(null)} // clicking on overlay closes popup
  >
    <div
      style={popupContent}
      onClick={(e) => e.stopPropagation()} // prevent iframe clicks from closing
    >
      <iframe
        src={popup.route}
        title={popup.title}
