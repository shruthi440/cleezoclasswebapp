...
// ✅ Fetch teachers
router.get('/teachersmessage', (req, res) => {
  db.query('SELECT name FROM management_login_creation WHERE user_type = "teacher"', (err, results) => {
...
// ✅ Fetch all messages
router.get('/messagesdata', (req, res) => {
